...
2. Include real, working URLs in parentheses when helpful — link to relevant retailers, guides, comparison sites, or location-aware tools. Examples:
...
3. Prefix subtasks with a mini-label when it clarifies intent: "Decision:", "Research:", "Project plan:", etc.
4. Surface actual decisions the user needs to make — e.g., "Decision: buy plans online ($5-15 on Etsy) vs design your own" instead of "Create a plan".
...
[
  ...
  {"description": "Decision: buy plans online ($5-15 on etsy.com/search?q=birdhouse+plans) vs design your own", "assignee_type": "human", "depends_on": null},
